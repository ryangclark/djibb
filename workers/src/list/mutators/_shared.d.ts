import { z } from 'zod';
import type { MutatorReturn, ReadonlyJSONObject, ReadTransaction, WriteTransaction } from 'replicache';
 ...
 */
export declare const EDIT_ROLES: readonly AuthorizationRole[];
/**
 ...
 * auth-rules mutation.
 */
export declare const OWNER_ROLES: readonly AuthorizationRole[];
/**
 ...
 */
export declare const SYSTEM_ROLES: readonly AuthorizationRole[];
/**
 ...
 */
export declare const MutationEnvelopeArgsSchema: z.ZodObject<{
 ...
 */
export type ServerMutatorOutcome = undefined | void | {
    status: 'stale' | 'gone';
};
export type ServerMutator<A> = (args: A, ctx: ServerMutatorCtx) => ServerMutatorOutcome;
export type ClientMutator<A> = (tx: WriteTransaction, args: A, ctx: ClientMutatorCtx) => MutatorReturn;
/**
 ...
 * step 5.
 */
export type CapturePreState<A> = (tx: ReadTransaction, args: A) => Promise<PreState>;
/**
 ...
 */
export type Inverse<A> = (args: A, preState?: PreState) => {
    name: string;
    args: unknown;
} | null;
/**
 ...
 */
export declare const FRICTION_TIER_MUTATORS: readonly string[];
export type FrictionTier = 'two-step-confirm';
export declare function isFrictionTier(name: string): boolean;
/**
 ...
 */
export declare const COALESCING_MUTATORS: readonly string[];
/** Window in milliseconds within which same-target repeats coalesce. */
export declare const COALESCE_WINDOW_MS = 500;
/**
...
export declare function toStoredValue(value: unknown): ReadonlyJSONObject;
/**
 ...
 */
export declare function parseStoredAuthorizationRules(raw: unknown): AuthorizationRules;
/**
 ...
 */
export declare function countOwners(rules: AuthorizationRules): number;
/**
 ...
 */
export declare function findOwnerAccountId(rules: AuthorizationRules): string | null;
/**
 ...
 */
export declare function assertSingleOwner(rules: AuthorizationRules): void;
/**
 ...
 */
export declare class SingleOwnerInvariantError extends Error {
