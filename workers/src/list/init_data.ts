...
const strawberryIceCreamRecipe: Array<ListElement> = [
    ...
    },
    {
        ...
        time_deleted: null,
        time_updated: new Date().toISOString(),
        title: "Adjust oven rack to middle position and preheat to 375º. Slice off the strawberries' leafy caps, removing as little fruit as possible. Halve the berries, place in a 9-by-13-inch glass or ceramic baking dish, then stir in sugar and salt.",
        type: 'item',
        version: 1,
    },
    {
        ...
        time_deleted: null,
        time_updated: new Date().toISOString(),
        title: 'Roast, stirring once or twice along the way, until the berries are fork-tender and swimming in bright red juice, about 35 minutes. Strain through a double-mesh sieve into a 3-quart stainless steel saucier, gently mashing the berries with a flexible spatula until only 1/2 cup (5 ounces) remains; discard pulp, or refrigerate for up to a week for another use.',
        type: 'item',
        version: 1,
    },
    {
        ...
        time_deleted: null,
        time_updated: new Date().toISOString(),
        title: 'Simmer strawberry juice over medium heat, scraping the pot with a heat-resistant spatula until thick, syrupy, and reduced to 1-2/3 cups (16 ounces), about 15 minutes. Whisk in cream, lemon juice, rose water, and liqueur. Cover and refrigerate until very cold, at least 4 hours, or up to 1 week.',
        type: 'item',
        version: 1,
    },
    {
        ...
        time_deleted: null,
        time_updated: new Date().toISOString(),
        title: "Churn according to the manufacturer's directions until the ice cream is fluffy and light. If your machine has an open top, cover with an inverted cake pan to keep it cold as it churns. Meanwhile, place a flexible spatula and quart container (an empty yogurt tub works great) in the freezer.",
        type: 'item',
        version: 1,
    },
    {
        ...
        time_deleted: null,
        time_updated: new Date().toISOString(),
        title: 'Enjoy freshly churned ice cream as "soft serve," or scrape it into the chilled container. Press a sheet of plastic against the ice cream to minimize risk of freezer burn and seal. Freeze until firm enough to scoop, about 12 hours, or up to 3 weeks.',
        type: 'item',
        version: 1,
    },
    {
